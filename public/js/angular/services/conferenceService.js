app.factory('conferenceService',
    [
        ...
        'watchService',
        'roomService',
        function ($scope, $http, $routeParams, $rootScope, stunService, watchService, roomService) {
    $scope.controls = null;
    ...
    return {
        createRoom: function(_config) {
            ...
            watchService.emit("rooms:update", {});

            roomService.prepForBroadcast({
                roomName: self.roomName,
                username: USERNAME,
                users: [USERNAME]
            });
