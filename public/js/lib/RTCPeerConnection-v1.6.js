...
function RTCPeerConnection(options) {
    ...
    peer.onaddstream = function(event) {
       ...
       /* // onRemoteStreamEnded(MediaStream)
        remoteMediaStream.removeStream = function() {
            if (options.onRemoveStream) options.onRemoveStream(remoteMediaStream);
        };
*/
...
function getUserMedia(options,callback) {
    ...
    var opt = {};
    opt.audio = options.audio || true;
    opt.video = options.isVideo ? video_constraints : false;

    n.getMedia = n.webkitGetUserMedia || n.mozGetUserMedia;
    n.getMedia(opt , streaming, function(e) {
